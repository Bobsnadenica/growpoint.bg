...
| --- | --- | --- | --- |
| Public site and SEO | Safe smoke on `www.growpoint.bg` and CloudFront | Public routes, sitemap, robots, canonical metadata, live consultant routes, and SPA fallback | Cloudflare DNS cutover to CloudFront; scheduled rebuild/deploy for fresh profile SEO metadata |
