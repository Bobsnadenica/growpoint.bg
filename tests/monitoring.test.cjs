...
test("profile completeness uses the six client and seventeen expert fields", () => {
  ...
  const consultant = { ownerUserId: "m", profileType: "mentor", headline: "Title", bio: "Bio", experienceSummary: "Experience", experienceHighlights: ["One"], educationHighlights: ["School"], specializations: ["Career"], languages: ["bg"], idealFor: ["People"], consultationTopics: ["Career"], workApproach: "Coaching", availability: ["2026-09-07"] };
  ...
  assert.equal(profileCompletion(mentor, { ...consultant, languages: [] }), 94);
